...
<head>
    <meta charset="utf-8">
    <title>iEdu - Sistema de Gestão Académica</title>
...
<div class="header">
    <div class="container">
        <a class="site-logo" href="index.html"><img src="assets/frontend/layout/img/logos/logo-corp-turquoise.png" alt="Metronic FrontEnd"></a>
        ...
        <div class="header-navigation pull-right font-transform-inherit">
            <ul>
                ...
                <li>
                    <a href="http://keenthemes.com/preview/metronic/theme/templates/admin" target="_blank">Admin theme</a>
                </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 padding-top-10">
                2014 © Metronic Shop UI. ALL Rights Reserved. <a href="#">Privacy Policy</a> |
